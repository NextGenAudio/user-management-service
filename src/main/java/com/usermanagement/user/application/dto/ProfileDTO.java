...
public class ProfileDTO {
    ...
    public ProfileDTO(long id,  String email, LocalDateTime createdAt, LocalDateTime updatedAt,String activationToken) {
        this.id = id;
        this.email = email;
    ...
    public static class ProfileDtoBuilder{
        ...
        public ProfileDTO build(){
            return new ProfileDTO(id,email,createdAt,updatedAt,activationToken);
        }
    }
